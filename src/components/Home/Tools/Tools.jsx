...
const skills = [
    { name: 'React', logo: faReact, color:'#00d8ff', isIconFont: true},
    { name: 'Angular', logo: faAngular, color:'#b63639', isIconFont: true},
    { name: 'Nodejs', logo: faNodeJs, color:'#57a048', isIconFont: true},
    { name: 'Javascript', logo: faJs, color:'#f4e225', isIconFont: true},
    { name: 'Css', logo: faCss3, color:'#2d53e5', isIconFont: true},
    { name: 'Html', logo: faHtml5, color:'#e4552d', isIconFont: true},
    { name: 'Php', logo: faPhp, color:'#7b7fb5', isIconFont: true},
    { name: 'Github', logo: faGithub, color:'#080808', isIconFont: true},
    { name: 'Jira', logo: faJira, color:'#237cf5', isIconFont: true},
    { name: 'Swfit', logo: faSwift, color:'#f1563e', isIconFont: true},
    { name: 'Android', logo: faAndroid, color:'#38df88', isIconFont: true},
    { name: 'FastApi', logo: SvgFastApi, color:'#38df88', isIconFont: false}
]
            ...
            <div className='skillsContainer'>
                {
                    skills.map((item, counter)=> (
                        <div className='skill' key={counter}>
                            { item.isIconFont ? <FontAwesomeIcon icon={item.logo} size='3x' color={item.color}/> : <item.logo size={48} /> }
                            <span>{item.name}</span>
                        </div>
                    ))
                }
